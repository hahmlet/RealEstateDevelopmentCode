#!/usr/bin/env python3
# TEST SCRIPT: Quick results viewer showing examples of processed municipal document tables and chunks
"""
...
def show_sample_results():
    ...
    tables_file = Path("/workspace/RealEstateDevelopmentCode/production_rag_data/Oregon/gresham/extracted_tables.json")
    chunks_file = Path("/workspace/RealEstateDevelopmentCode/production_rag_data/Oregon/gresham/accurate_chunks.jsonl")
    ...
    stats_file = Path('/workspace/RealEstateDevelopmentCode/production_rag_data/Oregon/gresham/accuracy_stats.json')
